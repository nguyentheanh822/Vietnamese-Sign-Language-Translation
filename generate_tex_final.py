...
At the international level, a number of continuous sign language datasets have been collected and made publicly available, as summarised in Table~\ref{tab:international}. The components of our dataset presented in Table~\ref{tab:international} will be detailed in Section 3: The VSL-GH Dataset. RWTH-Phoenix-2014T~\cite{rwth2014} is the most widely adopted benchmark for SLT research, featuring German Sign Language (DGS) videos with full gloss and translation annotations. However, it covers only the narrow domain of weather forecasting and provides neither body keypoints nor multiview recordings. How2Sign~\cite{how2sign2020} is the largest ASL dataset to date, providing multiview recording, multi-modal annotations, and broad topical coverage, making it the most comprehensive SLT resource currently available. In the healthcare domain, PaSCo1~\cite{pasco2025} provides French-Swiss Sign Language videos with medical annotations, while JUMILA-QSL-22~\cite{jumila2023} contains Qatari Sign Language videos across healthcare-related sentences with multiview support. Other notable datasets include KETI~\cite{keti2019} for emergency communication in Korean Sign Language, and CE-CSL~\cite{cecsl2024} for daily-life translation tasks in Chinese Sign Language.

\begin{table*}[t]
 \centering
 \caption{Overview of international continuous sign language datasets compared with \VSL{}.}
 \label{tab:international}
 \small
 \begin{tabular}{lcccccc}
 \toprule
 \textbf{Dataset} & \textbf{Sign Language} & \textbf{Domain} & \textbf{Multiview} & \textbf{Keypoints} & \textbf{Annotation} \\
 \midrule
 RWTH-Phoenix-2014T~\cite{rwth2014} & DGS (German) & Weather & No & No & Gloss + Text \\
 How2Sign~\cite{how2sign2020} & ASL (American) & Broad & Yes & Yes & Multimodal \\
 PaSCo1~\cite{pasco2025} & LSF-CH (French-Swiss) & Healthcare & No & Yes & Gloss + Text \\
 JUMILA-QSL-22~\cite{jumila2023} & QSL (Qatari) & Healthcare & Yes & Yes & Text \\
 KETI~\cite{keti2019} & KSL (Korean) & Emergency & No & Yes & Gloss + Text \\
 CE-CSL~\cite{cecsl2024} & CSL (Chinese) & Daily Life & No & Yes & Gloss + Text \\
 \textbf{\VSL{} (Ours)} & \textbf{VSL (Vietnamese)} & \textbf{Healthcare} & \textbf{Yes} & \textbf{Yes} & \textbf{Gloss + Text} \\
 \bottomrule
 \end{tabular}
\end{table*}
...
The sentences were constructed following Circular 32/2023/TT-BYT of the Vietnamese Ministry of Health, reflecting the actual general health examination procedure divided into five parts: (1)~Registration, (2)~Physical examination, (3)~Clinical examination, (4)~Paraclinical examination, and (5)~Conclusion. Detailed sentence distributions are provided in Table~\ref{tab:sent_dist}. On this basis, the sentences were developed through four steps: (1) candidate sentences were automatically generated using large language models (LLMs); (2) manual review to remove duplicates and refine phrasing; (3) validation of the practical applicability of sentences by physicians at Tan Hung General Hospital; (4) finalisation based on physician feedback.

\begin{table}[t]
 \centering
 \caption{Sentence distribution in \VSL{}.}
 \label{tab:sent_dist}
 \small
 \begin{tabular}{lc}
 \toprule
 \textbf{Category} & \textbf{No. sentences} \\
 \midrule
 \multicolumn{2}{l}{\textit{Distribution by examination stage}} \\
 Part 1: Registration & 68 \\
 Part 2: Physical examination & 32 \\
 Part 3: Clinical examination & 130 \\
 Part 4: Paraclinical examination & 40 \\
 Part 5: Conclusion & 30 \\
 \midrule
 \multicolumn{2}{l}{\textit{Distribution by sentence type}} \\
 Declarative sentences & 162 \\
 Interrogative sentences & 102 \\
 Exclamatory sentences & 36 \\
 \midrule
 \multicolumn{2}{l}{\textit{Distribution by sign feature}} \\
 Manual feature sentences (MF) & 185 \\
 Non-manual feature sentences (NMF) & 115 \\
 \midrule
 \textbf{Total sentences} & \textbf{300} \\
 \bottomrule
 \end{tabular}
\end{table}
...
Table~\ref{tab:dataset_stats} summarises the key statistics of \VSL{}. The dataset comprises 8,400 videos (4,200 frontal-view and 4,200 lateral-view) partitioned under a signer-independent protocol: S01--S04 are assigned to training (7,200 videos), S05 to validation (600 videos), and S06 to testing (600 videos). This split guarantees zero signer overlap across partitions, enabling a rigorous evaluation of model generalisation to unseen signers.

\begin{table}[t]
 \centering
 \caption{Statistics of the \VSL{} dataset.}
 ...
 \midrule
 Sign language videos & 7,200 & 600 & 600 & 8,400 \\
 Frontal-view videos & 3,600 & 300 & 300 & 4,200 \\
 Lateral-view videos & 3,600 & 300 & 300 & 4,200 \\
 \addlinespace
 Avg.\ frames / video & \multicolumn{4}{c}{107.9 (55--151)} \\
 Camera views per video & \multicolumn{4}{c}{2 (frontal + lateral)} \\
 \midrule
 Sentences & 300 & 300 & 300 & 300 \\
 Unique glosses & -- & -- & -- & 466 \\
 Total gloss tokens & -- & -- & -- & 1,174 \\
 Annotation error rate & -- & -- & -- & 0.12\% \\
 \midrule
 Number of signers & 4 & 1 & 1 & 6 \\
 Signers not in train set & -- & 1 & 1 & -- \\
 \midrule
 \multicolumn{5}{c}{\textit{2D keypoints}} \\
 \cmidrule{2-4}
 Body pose & \multicolumn{3}{c}{25} \\
 Facial landmarks & \multicolumn{3}{c}{70} & 137 \\
 Hand pose (two hands) & \multicolumn{3}{c}{21 + 21} \\
 \bottomrule
 \end{tabular}
\end{table}
...
We adopt a signer-independent evaluation protocol, as outlined in Table~\ref{tab:dataset_stats}. The test set consists of a signer who never appears during training. Signers S01--S04 are assigned to the training set, S05 to the validation set, and S06 to the test set, ensuring zero signer overlap across partitions.
